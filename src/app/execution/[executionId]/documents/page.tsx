...
import { ExecutionDocumentsView } from "@/components/execution/ExecutionDocumentsView";

export default function CustomerExecutionDocumentsPage({ params }: { params: Promise<{ executionId: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <ExecutionDocumentsView project={project} currentRole={currentRole} />
      </div>
    </div>
  );
}
