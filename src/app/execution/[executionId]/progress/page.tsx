...
import { ExecutionProgressView } from "@/components/execution/ExecutionProgressView";

export default function CustomerExecutionProgressPage({ params }: { params: Promise<{ executionId: string }> }) {
  ...
  if (isLoading) return <div className="p-8 text-center text-slate-400">Loading progress reports...</div>;
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <ExecutionProgressView project={project} currentRole={currentRole} />
      </div>
    </div>
  );
}
