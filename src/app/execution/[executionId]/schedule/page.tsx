...
export default function CustomerExecutionSchedulePage({ params }: { params: Promise<{ executionId: string }> }) {
  ...
  if (isLoading) return <div className="p-8 text-center text-slate-400">Loading schedule...</div>;
