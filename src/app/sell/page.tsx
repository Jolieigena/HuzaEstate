    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-40 overflow-hidden bg-slate-900">
        ...
        <div className="relative max-w-5xl mx-auto px-6 sm:px-10 text-center">
          ...
          <p className="text-xl text-slate-200 max-w-2xl mx-auto mb-12 font-medium">Join the thousands of homeowners who trust HuzaEstate's elite agent network to sell their properties at peak market value.</p>
          ...
          <div className="max-w-2xl mx-auto bg-white rounded-3xl p-6 shadow-2xl text-left">
            ...
            <form className="flex flex-col sm:flex-row gap-3">
              ...
              <button type="button" className="w-full sm:w-auto bg-slate-900 hover:bg-[#2ec440] text-white font-bold py-3.5 px-8 rounded-xl transition-colors whitespace-nowrap">
                Get Valuation
              </button>
            </form>
          </div>
      ...
      <section className="bg-white py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-slate-500 mb-10">Talk to a HuzaEstate local expert today and see how we can maximize your return.</p>
          <button className="bg-slate-900 hover:bg-[#2ec440] text-white font-bold py-4 px-10 rounded-xl transition-colors shadow-lg">
            Contact an Agent
          </button>
        </div>
      </section>
