    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-40 overflow-hidden bg-slate-900">
        <div className="absolute inset-0 opacity-40">
          <Image 
            src="https://images.unsplash.com/photo-1756245994834-61974c290b61?q=80&w=2000&auto=format&fit=crop"
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-10 py-24 -mt-20 relative z-10">
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Link href="/properties?type=rent" className="group relative h-80 rounded-3xl overflow-hidden bg-slate-900 shadow-xl">
            <Image 
              src="https://images.unsplash.com/photo-1717960331841-a36791e8d2f5?q=80&w=800&auto=format&fit=crop"
          ...
          <Link href="/properties?type=rent" className="group relative h-80 rounded-3xl overflow-hidden bg-slate-900 shadow-xl md:-translate-y-8">
            <Image 
              src="https://images.unsplash.com/photo-1756245994848-1eb2be3b9b63?q=80&w=800&auto=format&fit=crop"
              alt="Shared Homes"
              fill
              className="object-cover opacity-60 group-hover:opacity-80 group-hover:scale-105 transition-all duration-500"
            />
          ...
          <Link href="/properties?type=rent" className="group relative h-80 rounded-3xl overflow-hidden bg-slate-900 shadow-xl">
            <Image 
              src="https://images.unsplash.com/photo-1678225892688-e4a3bd3d9214?q=80&w=800&auto=format&fit=crop"
              alt="Short Term"
              fill
              className="object-cover opacity-60 group-hover:opacity-80 group-hover:scale-105 transition-all duration-500"
            />
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 relative h-[600px] rounded-3xl overflow-hidden shadow-2xl">
              <Image 
                src="https://images.unsplash.com/photo-6vKo_e01VYY?q=80&w=1000&auto=format&fit=crop"
                alt="Happy Renter"
                fill
                className="object-cover"
              />
