  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-6 py-20">
      <div className="max-w-lg w-full text-center bg-white rounded-3xl border border-slate-100 shadow-sm p-10">
        ...
        <h1 className="text-2xl font-black text-slate-900 mb-3">The Owner Portal is for sellers &amp; landlords</h1>
        <p className="text-slate-500 mb-8">Become a seller to post listings and manage your buyer and renter inquiries — it only takes a minute and there&apos;s no approval wait.</p>
