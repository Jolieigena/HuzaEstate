  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-6 py-20">
      <div className="max-w-lg w-full text-center bg-white rounded-3xl border border-slate-100 shadow-sm p-10">
        ...
        <p className="text-slate-500 mb-8">Manager access is granted by a HuzaEstate administrator — reach out to your account administrator to be set up with a Manager Portal login and unlock your listings dashboard, tenant screening, and rent collection tools.</p>
      </div>
    </div>
  );
}
